 ...
 * <ul>
 *   <li>{@link WebApp.impl.ImagenImpl#getTexto <em>Texto</em>}</li>
 *   <li>{@link WebApp.impl.ImagenImpl#getUrl <em>Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImagenImpl extends MinimalEObjectImpl.Container implements Imagen {
	...
	protected EClass eStaticClass() {
		return WebAppPackage.Literals.IMAGEN;
	}
	...
	public void setTexto(String newTexto) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebAppPackage.IMAGEN__TEXTO, oldTexto, texto));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebAppPackage.IMAGEN__URL, oldUrl, url));
	}
