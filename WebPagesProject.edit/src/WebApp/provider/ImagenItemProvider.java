...
/**
 * This is the item provider adapter for a {@link WebApp.Imagen} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImagenItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Imagen_texto_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Imagen_texto_feature", "_UI_Imagen_type"),
				 WebAppPackage.Literals.IMAGEN__TEXTO,
				 true,
				 false,
				 false,
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Imagen_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Imagen_url_feature", "_UI_Imagen_type"),
				 WebAppPackage.Literals.IMAGEN__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Imagen)object).getTexto();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Imagen.class)) {
			case WebAppPackage.IMAGEN__TEXTO:
			case WebAppPackage.IMAGEN__URL:
