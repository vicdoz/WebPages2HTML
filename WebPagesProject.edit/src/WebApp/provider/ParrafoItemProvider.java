...
/**
 * This is the item provider adapter for a {@link WebApp.Parrafo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParrafoItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebAppPackage.Literals.PARRAFO__TEXTO,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Parrafo)object).getTexto();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Parrafo.class)) {
			case WebAppPackage.PARRAFO__TEXTO:
